...
//      ->setComment("Track MTD quality BDT weights");
  desc.add<edm::FileInPath>("qualityBDT_weights_file",
                            edm::FileInPath("RecoMTD/TimingIDTools/data/4DMTD_tree_v2_wDispl_d7_Reg_bugfix_BaseScore.xml"))
      ->setComment("Track MTD quality BDT weights");
  // desc.add<edm::FileInPath>("qualityBDT_weights_file",
  //                           edm::FileInPath("RecoMTD/TimingIDTools/data/test_4DMTD_tree_v2_wDispl_d5_Reg.xml"))
  //     ->setComment("Track MTD quality BDT weights");
//  desc.add<edm::FileInPath>("qualityBDT_weights_file",
//                            edm::FileInPath("/afs/cern.ch/user/m/mklevs/CMSSW_15_0_0_pre2/src/cmssw/RecoMTD/TimingIDTools/data/4DMTD_tree_v2_wDispl_d7_Reg.xml"))
//      ->setComment("Track MTD quality BDT weights");
//  desc.add<edm::FileInPath>("qualityBDT_weights_file",
//                            edm::FileInPath("/afs/cern.ch/user/m/mklevs/CMSSW_15_0_0_pre2/src/cmssw/RecoMTD/TimingIDTools/data/test_4DMTD_tree_v2_wDispl_d5_Reg.xml"))
//      ->setComment("Track MTD quality BDT weights");
